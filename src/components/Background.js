export const Background = () => (
	<div className="">
		<p>
			Hello there! I'm Tony, an aspiring{" "}
			<span className="highlight">software engineer</span> based in the
			Bay Area.
		</p>
		<br />
		<p>
			I enjoy creating things for the web and applications that automate
			even the smallest tasks. I just find joy in learning new
			technologies through the journey.
		</p>
		<br />
		<p>
